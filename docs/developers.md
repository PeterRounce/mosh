# Mosh Developer and Distributor Guide
...
## How it works
  ...
  and sends its port number and a secret key back to the client over SSH.
  The SSH connection is then shut down and the terminal session begins
  over UDP.
